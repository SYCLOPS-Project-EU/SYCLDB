...
public class CalciteServer {
  ...
  public interface Iface {
    ...
    public PlanResult parse(java.lang.String sql) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void parse(java.lang.String sql, org.apache.thrift.async.AsyncMethodCallback<PlanResult> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_parse(java.lang.String sql) throws org.apache.thrift.TException
    {
    ...
    public PlanResult recv_parse() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void parse(java.lang.String sql, org.apache.thrift.async.AsyncMethodCallback<PlanResult> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      parse_call method_call = new parse_call(sql, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class parse_call extends org.apache.thrift.async.TAsyncMethodCall<PlanResult> {
      private java.lang.String sql;
      public parse_call(java.lang.String sql, org.apache.thrift.async.AsyncMethodCallback<PlanResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.sql = sql;
      }
      ...
      @Override
      public PlanResult getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class shutdown<I extends Iface> extends org.apache.thrift.ProcessFunction<I, shutdown_args, shutdown_result> {
      public shutdown() {
        super("shutdown");
      }
      ...
      @Override
      public shutdown_result getEmptyResultInstance() {
        return new shutdown_result();
      }

      @Override
      public shutdown_result getResult(I iface, shutdown_args args) throws org.apache.thrift.TException {
        shutdown_result result = getEmptyResultInstance();
        iface.shutdown();
        return result;
      }
    }

    public static class parse<I extends Iface> extends org.apache.thrift.ProcessFunction<I, parse_args, parse_result> {
      public parse() {
        super("parse");
      }
      ...
      @Override
      public parse_result getEmptyResultInstance() {
        return new parse_result();
      }

      @Override
      public parse_result getResult(I iface, parse_args args) throws org.apache.thrift.TException {
        parse_result result = getEmptyResultInstance();
        result.success = iface.parse(args.sql);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class shutdown<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, shutdown_args, Void, shutdown_result> {
      public shutdown() {
        super("shutdown");
      }
    ...
    public static class parse<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, parse_args, PlanResult, parse_result> {
      public parse() {
        super("parse");
      }
      ...
      @Override
      public org.apache.thrift.async.AsyncMethodCallback<PlanResult> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<PlanResult>() { 
          @Override
          public void onComplete(PlanResult o) {
            parse_result result = new parse_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      @Override
      public void start(I iface, parse_args args, org.apache.thrift.async.AsyncMethodCallback<PlanResult> resultHandler) throws org.apache.thrift.TException {
        iface.parse(args.sql,resultHandler);
      }
    }
...
;
  ...
  public static class parse_args implements org.apache.thrift.TBase<parse_args, parse_args._Fields>, java.io.Serializable, Cloneable, Comparable<parse_args>   {
    ...
    public parse_args setSql(@org.apache.thrift.annotation.Nullable java.lang.String sql) {
      this.sql = sql;
      return this;
    }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("parse_args(");
      boolean first = true;
  ...
  public static class parse_result implements org.apache.thrift.TBase<parse_result, parse_result._Fields>, java.io.Serializable, Cloneable, Comparable<parse_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable PlanResult success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PlanResult.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public parse_result(parse_result other) {
      if (other.isSetSuccess()) {
        this.success = new PlanResult(other.success);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public PlanResult getSuccess() {
      return this.success;
    }

    public parse_result setSuccess(@org.apache.thrift.annotation.Nullable PlanResult success) {
      this.success = success;
      return this;
    }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("parse_result(");
      boolean first = true;
